...
public class ENVNHomeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnAdd.setText("Add more word into dictionary");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ENVNHomeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ENVNHomeFrame().setVisible(true);
            }
        });
    }
